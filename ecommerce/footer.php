			...
			<div class="row">
				...
				<div class="col-md-4"><!--footer contact widget-->
					...
					<ul class="contact-widget">
						<li class="fphone">Telefon : <?php echo $ayarcek['ayar_tel']; ?><br>Faks : <?php echo $ayarcek['ayar_faks']; ?></li>
		...
		<div class="container">
			<div class="row">
				<div class="col-md-9">
					...
					<div class="f-credit">&copy;<?php echo $ayarcek['ayar_author'] ?> <a href="https://beratozaydin.com">beratozaydin.com</a></div>
